...
import { IN_TOTO_PAYLOAD_TYPE, parseSignedReceiptPackage } from '../../src/domain/attestation.js';
import type { GitHubActionsTrustPolicy } from '../../src/domain/proof.js';
import { gateArtifact, headSha as sourceHead, signedGatePackage } from '../fixtures/receipts.js';
...
function parsedReceipt(options: { transparency?: boolean } = {}) {
  return parseSignedReceiptPackage(signedGatePackage(gateArtifact(), options), sha256);
}
