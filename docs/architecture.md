...
| **Implemented in threadloop-contracts**          | YAML compiler, candidate validators, executor mapping helpers, and internal conformance-corpus checks.                                                             | Development tooling in [threadloop-contracts](https://github.com/nnennandukwe/threadloop-contracts), tagged `v0.1.0`.                                                                                                                                                                                                                           |
...
| **Deferred to the controller-runtime milestone** | Configurable graph selection/execution, durable graph-bound runs and Execution Claims, and conformance by a real controller through the external harness.          | [Contract tracker #110](https://github.com/nnennandukwe/threadloop/issues/110), [conformance handoff](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/controller-conformance-v0.1/run-invariant-follow-up.md), and [generated state-machine tests #112](https://github.com/nnennandukwe/threadloop/issues/112). |
...
controller harness that consumes the pinned conformance corpus, launches one external process per case, and validates
responses. Synthetic subjects exercise the harness; a real ThreadLoop controller has not demonstrated conformance. After
the v0.1 freeze the corpus moved, with the rest of the contracts, to
[threadloop-contracts](https://github.com/nnennandukwe/threadloop-contracts); RunInvariant's existing pin to a
ThreadLoop commit stays valid. The
[integration handoff](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/controller-conformance-v0.1/run-invariant-follow-up.md)
...
[governed PR YAML](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/workflow-graph-v0.1/fixtures/valid/governed-pr.yaml).
Its companion
[compiled envelope](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/workflow-graph-v0.1/fixtures/valid/governed-pr.compiled.json),
[canonical bytes](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/workflow-graph-v0.1/fixtures/valid/governed-pr.canonical),
and
[graph binding](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/workflow-graph-v0.1/fixtures/valid/governed-pr.binding.json)
show the exact transformation. The
[minimal release vector](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/workflow-graph-v0.1/fixtures/valid/minimal-release.yaml)
offers a smaller example; the
[release-to-publish profile](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/workflow-graph-v0.1/fixtures/valid/release-to-publish.yaml)
illustrates another accepted graph shape without implementing publication.

The contracts repository's `compileWorkflowProfile(source)` helper accepts YAML text and returns either a graph/digest
envelope or structured diagnostics. Normalization establishes declaration order and defaults and discards the optional
root author description. The graph's canonical UTF-8 JSON is hashed with SHA-256; `graph_digest` is outside the hashed
graph payload. For exact byte, ordering, and number rules, use the
[normative graph contract](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/workflow-graph-v0.1/README.md#compilation-and-graph-identity).
Do not apply those rules indiscriminately to executor, GAAP, or RunInvariant protocols; each specifies its own byte and
digest conventions.

To inspect and check the published examples, clone the tagged release of
...
These specifications are **accepted in Controller Contract v0.1** and live in
[threadloop-contracts](https://github.com/nnennandukwe/threadloop-contracts), tagged `v0.1.0`, with their validation
tooling. The configurable runtime and conformance by a real controller remain deferred as described above. ThreadLoop
keeps a vendored copy of the Governed PR profile, and `tests/unit/lifecycle-contract-drift.test.ts` fails if the runtime
lifecycle and that profile drift apart.

| Contract                                                                                                                                                 | Schemas and examples                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Supporting evidence                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Workflow Profile / Compiled Graph](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/workflow-graph-v0.1/README.md)       | [Profile schema](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/workflow-graph-v0.1/schemas/workflow-profile.schema.json), [graph schema](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/workflow-graph-v0.1/schemas/compiled-graph.schema.json), [binding schema](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/workflow-graph-v0.1/schemas/graph-binding.schema.json), [governed PR example](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/workflow-graph-v0.1/fixtures/valid/governed-pr.yaml). | [Capability catalog](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/workflow-graph-v0.1/capabilities.md), [preservation manifest](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/workflow-graph-v0.1/preservation.json), and [current lifecycle mapping](current-lifecycle-graph-mapping.md).                                                                                                            |
| [Controller Decision / Action Request](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/controller-v0.1/README.md)        | [Input schema](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/controller-v0.1/schemas/controller-input.schema.json), [decision schema](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/controller-v0.1/schemas/controller-decision.schema.json), [request schema](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/controller-v0.1/schemas/action-request.schema.json), [example manifest](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/controller-v0.1/fixtures/valid/manifest.json).                | [Decision precedence and remedy selection](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/controller-v0.1/selection.md).                                                                                                                                                                                                                                                                                                                  |
| [Execution Claim / Attempt](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/execution-v0.1/README.md)                    | [Claim schema](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/execution-v0.1/schemas/execution-claim.schema.json), [Attempt schema](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/execution-v0.1/schemas/attempt.schema.json), [scenario corpus](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/execution-v0.1/fixtures/scenarios.json).                                                                                                                                                                                             | [Recovery evidence schema](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/execution-v0.1/schemas/recovery-evidence.schema.json) and [rejection corpus](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/execution-v0.1/fixtures/rejections.json).                                                                                                                                                          |
| [Executor interface / GAAP mapping](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/executor-v0.1/README.md)             | [Request schema](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/executor-v0.1/schemas/executor-request.schema.json), [result schema](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/executor-v0.1/schemas/executor-result.schema.json), [mapping-policy schema](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/executor-v0.1/schemas/gaap-mapping-policy.schema.json).                                                                                                                                                                | The contract links its pinned upstream artifacts and valid/invalid example corpora; [#111](https://github.com/nnennandukwe/threadloop/issues/111) owns runtime invocation and admission.                                                                                                                                                                                                                                                                                   |
| [Controller Conformance Protocol](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/controller-conformance-v0.1/README.md) | [Request schema](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/controller-conformance-v0.1/schemas/request.schema.json), [response schema](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/controller-conformance-v0.1/schemas/response.schema.json), [38-case manifest](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/controller-conformance-v0.1/manifest.json), [golden vectors](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/controller-conformance-v0.1/vectors/golden.json).                | [Coverage](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/controller-conformance-v0.1/coverage.md), [compatibility pins](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/controller-conformance-v0.1/compatibility.json), and [RunInvariant integration handoff](https://github.com/nnennandukwe/threadloop-contracts/blob/v0.1.0/docs/contracts/controller-conformance-v0.1/run-invariant-follow-up.md). |
